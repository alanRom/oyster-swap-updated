...
import { SwapInstruction } from "@solana/spl-token-swap";
import {numberToBigint} from '../utils/utils'
...
//       poolTokenAmount: u64(poolTokenAmount). .toBuffer(),
  ...
  dataLayout.encode(
    {
      ...
      minimumAmountOut: numberToBigint(minimumAmountOut),
    },
    data,
  );
